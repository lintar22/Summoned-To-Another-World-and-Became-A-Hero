...
| Atribut | Detail |
|:--------|:-------|
| 🎮 **Judul** | Summoned To Another World and Became A Hero |
...
```
✦ ─────────────────────────────────────────────── ✦
Bertahun-tahun dunia ini diambang kehancuran
 Kamulah satu-satunya yang kupercaya, Arga.
✦ ─────────────────────────────────────────────── ✦
```
...
| `↑` `↓`/ `W` `S`| Navigasi pilihan menu |
| `E` | Interaksi dengan NPC |
| `←` `→`/`A` `D` | Gerak kiri kanan (Eksplorasi) |
